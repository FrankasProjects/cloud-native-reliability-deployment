...
| 57 / 30|  Lee et al. | Optimization of cloud resource subscription policy | 2012 | Conference | .  | No |   |
| 58 / 31|  Russo et al. | Serverless Functions in the Cloud-Edge Continuum: Challenges and Opportunities | 2018 | Conference |   | No |   |
| 59 / 32|  Beserra et al. | Cloudstep: A step-by-step decision process to support legacy application migration to the cloud | 2018 | Conference |   | No |   |
| 60 / 33|  Rak et al. | Cost/Performance Evaluation for Cloud Applications Using Simulations | 2018 | Conference |   | No |   |
